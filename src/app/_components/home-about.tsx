        ...
        <Grid container spacing={8}>
          <Grid size={{ xs: 12, md: 7 }} sx={{ pr: 6 }}>
            <Box sx={{ position: 'relative', width: { xs: '100%', md: 400 } }}>
              ...
              >
                Built to Elevate. Driven by Results.
              </Typography>
            </Box>
            <Box sx={{ position: 'relative', zIndex: 2 }}>
              ...
              >
                Your growth is our mission. Every click. Every campaign. Every time.
              </Typography>
              <Typography
                sx={{
              ...
              >
                At Apex Digital Ventures, we don&apos;t just run campaigns — we build digital ecosystems that convert. Based in Las Cruces, New Mexico, we&apos;re a passionate team of marketers, strategists, and creatives who believe great marketing should be measurable, scalable, and built around your goals.
              </Typography>
            </Box>
            <Box>
              <Grid
