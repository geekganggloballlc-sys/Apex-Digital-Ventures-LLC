    ...
    >
      <Container maxWidth='md'>
        ...
        >
          ...
          >
            Whether you&apos;re a local business looking to get found online, or a growing brand ready to scale — we bring the tools, talent, and tenacity to make it happen.
          </Typography>
        </Box>
      </Container>
      <Container
      ...
      >
        ...
        <Box sx={{ textAlign: 'center', mt: 5, color: '#fbfbfb' }}>
          <Typography>
            Since its founding in 2026, {AppConfig.appName} has been helping
            businesses dominate online through smart strategy and bold creative.
          </Typography>
        </Box>
      </Container>
    </Box>
